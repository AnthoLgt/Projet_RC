...
/**
 * Méthode permettant de lancer la recherche pour un tag.
 * 
 * @param {type} tags Tags recherché
 */
function search(tags){
    if(Object.keys(ALL_DATA).length < 3 && typeof(ALL_DATA[tags]) === "undefined"){ // On vérifie qu'il n'y a pas 3 tags et que le tag n'a pas déjà été soumis
       flickSearch(WOE_ID, tags, DATE_DEFAULT);    
    }
}
